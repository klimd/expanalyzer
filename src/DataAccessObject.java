...
public class DataAccessObject 
{
	...
	private ExplanationView view;
	private ExplanationModel model;
	List <ExplanationModel> ExplanationModels = new ArrayList<ExplanationModel>();
	...
	//private List<ExplanationView> getPage(int Page, int Size)
	public List<ExplanationModel> getPage()
	{
		System.out.println("This is the ExplanationModels list: ");
		System.out.println(ExplanationModels);
	...
	public void setPage(int Page, int Size)
	{
		...
		{
			int NumField = Page + i;
		/* 	view.setNumField(Integer.toString(NumField));
			view.setDerivProbField(DerivProb.get(NumField).toString());
			view.setRootProbField(RootProb.get(NumField).toString());
			view.setFinalStateField(FinalState.get(NumField).toString());
			view.setRootsField(Roots.get(NumField).toString());
		*/
			model.setDerivProb(DerivProb.get(NumField).toString());
			model.setRootProb(RootProb.get(NumField).toString());
			model.setFinalState(FinalState.get(NumField));
			
			ExplanationModels.add(model);
			//model.setRoots(Roots.get(NumField));
		}
	}
	public void callInsertMongo() throws Exception
	{
		insertMongo();
	}
	public void insertMongo() throws Exception
    {
        ...
        FileReader file = new FileReader(controller.getPathField());
